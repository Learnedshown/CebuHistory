        ...
        if (!context.Stories.Any())
        {
            var stories = new[]
            {
                new Story
                {
                    ...
                    CoverImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Magellan%27s_Cross_Cebu_Philippines.jpg/800px-Magellan%27s_Cross_Cebu_Philippines.jpg",
...
The cross, now enshrined inside a chapel near the Basilica Minore del Santo Niño, has been encased in tindalo wood to protect it from relic-seekers who once chipped pieces away believing it had miraculous powers. Today it remains one of Cebu's most visited landmarks.",
                ...
                new Story
                {
                    ...
                    CoverImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Battle_of_Mactan.jpg/800px-Battle_of_Mactan.jpg",
...
Magellan brought roughly 49 men ashore in the early morning. The coral reef prevented his ships from getting close enough to provide covering fire. Today Lapu-Lapu is celebrated as the first Filipino hero, the first to resist colonial conquest.",
                ...
                new Story
                {
                    ...
                    CoverImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Seniorsantoninyo.jpg/600px-Seniorsantoninyo.jpg",
...
The image itself — just 27 centimeters tall, carved from dark wood in the Flemish style — shows the Child Jesus holding an orb and wearing a small crown. Every January, millions descend on Cebu for the Sinulog Festival — nine days of processions, street dancing, and mass celebrating the Santo Niño.",
                ...
                new Story
                {
                    ...
                    CoverImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Fort_San_Pedro_in_Cebu_City.jpg/800px-Fort_San_Pedro_in_Cebu_City.jpg",
        ...
        if (!context.Photos.Any())
        {
            var photos = new[]
            {
                new Photo
                {
                    ...
                    ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Cebu_1900.jpg/800px-Cebu_1900.jpg",
                    IsPublicDomain = true,
                    Status = "Published",
                ...
                new Photo
                {
                    ...
                    ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Basilica_Minore_del_Santo_Ni%C3%B1o_de_Cebu.jpg/800px-Basilica_Minore_del_Santo_Ni%C3%B1o_de_Cebu.jpg",
                    IsPublicDomain = true,
                    Status = "Published",
                    UploadedAt = DateTime.UtcNow,
                },
                new Photo
                {
                    ...
                    ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Magellan%27s_Cross_Cebu.jpg/640px-Magellan%27s_Cross_Cebu.jpg",
                    IsPublicDomain = true,
                    Status = "Published",
                    UploadedAt = DateTime.UtcNow,
                },
                new Photo
                {
                    ...
                    ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Fort_San_Pedro_in_Cebu_City.jpg/800px-Fort_San_Pedro_in_Cebu_City.jpg",
                    IsPublicDomain = true,
                    Status = "Published",
                    UploadedAt = DateTime.UtcNow,
                },
                new Photo
                {
                    ...
                    ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Sinulog_Festival_Cebu.jpg/800px-Sinulog_Festival_Cebu.jpg",
                    IsPublicDomain = true,
                    Status = "Published",
                    UploadedAt = DateTime.UtcNow,
                },
